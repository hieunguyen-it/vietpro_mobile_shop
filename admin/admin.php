 <?php 
	if (!defined("TEMPLATE")) { // hàm để kiểm tra hằng số
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="index.php?page_layout=comment"><svg class="glyph stroked two messages"><use xlink:href="#stroked-two-messages"/></svg> Quản lý bình luận</a></li>
			<!-- <li><a href="?page_layout=mail"><svg class="glyph stroked two messages"><use xlink:href="#stroked-two-messages"/></svg> Quản lý Mail Server</a></li> -->
			<li><a href="index.php?page_layout=mailserver"><svg class="glyph stroked two messages"><use xlink:href="#stroked-two-messages"/></svg> Quản lý Mail Server</a></li>
	...
	if(isset($_GET['page_layout'])){
		switch($_GET['page_layout']){
			...
			// case 'mail': include_once('mail_data.php');break;
			// case 'edit_mail': include_once('edit_mail.php');break;
			
			case 'mailserver' : include_once('mailserver.php');break;
			case 'edit_mailserver' :include_once('edit_mailserver.php');break;
			
		}
	}
	else{
		include_once('dashbroad.php');
	}
