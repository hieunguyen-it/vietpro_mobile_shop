    ...
    if(isset($_POST['sbm'])){
        ...
        if($_FILES ['prd_image']['name'] == ""){
            ...
            if (in_array($str_type , $array_type) == true) {
                ...
                // viết câu truy vấn để cập nhật dòng sản phẩm
            ...
            // khi thực thi xong câu truy vấn thì về lại trang product
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Sản phẩm số <?php echo $prd_id ; ?></li>
        </ol>
    </div><!--/.row-->
    
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Sản phẩm: Sản phẩm số <?php echo $prd_id ; ?></h1>
        </div>
    </div><!--/.row-->
    <div class="row">
            <div class="col-lg-12">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <div>
                                        <img width="160" height="212" src="img/products/<?php echo $row["prd_image"] ; ?> ">
                                    </div>
                                </div>
                                <div class="form-group">
