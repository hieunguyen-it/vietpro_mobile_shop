					...
					<div class="panel-body">
                        <table 
                            ...
                            <?php 
                                ...
                                $list_pages .= '</ul>' ;
                                echo $list_pages ;
                                $sql = "SELECT * FROM user LIMIT $pre_row , $rows_pre_page ";
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><span class="label label-<?php if($row["user_level"] == 1){echo "danger" ;}else{echo "success" ;} ?>"><?php if($row["user_level"] == 1){echo "Admin" ;}else{echo "Member" ;} ?></span></td>
                                    <td class="form-group">
                                        <a href="index.php?page_layout=edit_user&page_id=<?php echo $row["user_id"] ; ?>" class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i></a>
                                        <a href="dell_user.php?page_id=<?php echo $row["user_id"] ; ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
                                    </td>
                                </tr>
                            <?php 
                                }
